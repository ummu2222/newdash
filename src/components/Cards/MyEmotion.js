...
import ICONS from '../Atoms/assets/icons/Icons'
import './Styles.css'
    ...
    return (
        <div className="card"  style={{marginTop:'10px'}} >
            <div className="card-body" style = {{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
                <div style = {{fontFamily: 'Roboto Mono', fontSize: '24px', fontStyle: 'normal', fontWeight: '700', lineHeight: '32px', letterSpacing: '0em', textAlign: 'left',}}>
                    My Emotion
                </div>
                <div>
