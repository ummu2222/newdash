      ...
      <div style={{display:"flex",justifyContent:"space-between"}}>
        ...
        <nav aria-label="Page navigation example">
          <ul className="pagination">
            <li className="page-item active"><a className="page-link" onClick={showBoth}>Both</a></li>
            <li className="page-item"><a className="page-link" onClick={showSpeed}>Speed</a></li>
            <li className="page-item"><a className="page-link" onClick={showVolume}>Volume</a></li>
