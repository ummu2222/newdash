...
const Calender = () => {
    ...
    return (
        <div className="card"  style={{marginTop:'10px'}} >
            <div className="card-body" style={{display: 'flex', flex: 1, flexDirection:'row', justifyContent: 'space-between', alignItems: 'center'}}>
                <div>
            ...
            <div className="card-body">
                <div style={{display: 'flex', flex: 1, flexDirection:'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    ...
                    <div style={{display: 'flex', flex: 1, flexDirection:'row', justifyContent: 'flex-end', alignItems: 'center'}}>
                        <img style={{height: 20}} src={ICONS.arrowLeft} alt="Left" />
                        <img style={{height: 20}} src={ICONS.arrowRight} alt="Right" />
                    </div>
                </div>
                    ...
                    {days.map(day => {
                        return (
                            <div>
                                ...
                                <div className= {(day.isSelected === 0 ? 'dateNotSelected' : 'dateSelected')}>
            ...
            <div className="card-body">
                                ...
                                <div className="card-body itemCard">
                                    <div>
                                        <div style = {{display: 'flex', flexDirection: 'row', justifyContent: 'space-between'}}>
                                            ...
                                            <div style={{alignItems: 'top', justifyContent: 'flex-end'}}>
                                                <img height='40px' src={item.status}></img>
                                            </div>
                                        </div>
                                        <div style={{display: 'flex', flex: 1, flexDirection:'row', alignItems: 'center',}}>
                                            {item.students.map(student => {
                                                return (
                                                    <div>
                                                        <img height='40px' src={student}></img>
                                                    </div>
                                                )
                                            })}
                                        </div>
                ...
                <div className="addNewBox" style = {{padding: 20, justifyContent: 'center', alignItems: 'center'}}>
                    <div style = {{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                        <div>
                            <img height = '50px' src = {ICONS.addNew}></img>
                        </div>
                        <div style = {{alignItems: 'center', justifyContent: 'center'}}>
                            <p className = "addNewText"  style = {{alignItems: 'center', justifyContent: 'center'}}>Add New</p>
                        </div>
                    </div>
                </div>
            </div>
